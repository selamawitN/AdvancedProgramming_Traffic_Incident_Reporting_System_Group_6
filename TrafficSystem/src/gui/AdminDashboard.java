...
public class AdminDashboard extends JFrame {
    ...
    private void buildUI() {
        ...
        // Incidents tab
        String[] incCols = {"ID", "Type", "Location", "Severity", "Status", "Reported By"};
        ...
        JPanel incBtns = new JPanel(new FlowLayout(FlowLayout.LEFT, 8, 8));
    ...
    private void loadData() {
        ...
        for (Incident i : incidents) {
            String reportedBy = i.getReporterName();
            if (reportedBy == null || reportedBy.isEmpty()) {
                reportedBy = i.getReportedById() > 0 ? "User #" + i.getReportedById() : "Anonymous";
            }
    ...
    private void resolveSelected() {
        ...
        if (row == -1) {
            JOptionPane.showMessageDialog(this, "Please select an incident first.",
        ...
        if (done) {
            ...
            JOptionPane.showMessageDialog(this, "Incident #" + id + " marked as Resolved!");
            loadData();
        }
    }
    ...
    private void markInProgress() {
        ...
        if (done) {
            Logger.log("STATUS", "Incident #" + id + " -> In Progress by " + adminName);
            JOptionPane.showMessageDialog(this, "Incident #" + id + " marked as In Progress!");
            loadData();
        }
    }
    ...
    private void deleteSelected() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            if (done) {
                Logger.log("DELETE", "Incident #" + id + " deleted by " + adminName);
                JOptionPane.showMessageDialog(this, "Incident #" + id + " deleted.");
                loadData();
            }
        }
    }
    ...
    private void showLogs() {
        ...
        JOptionPane.showMessageDialog(this, scroll, "System Logs - Last 50 entries", JOptionPane.PLAIN_MESSAGE);
    }
        ...
        UDPListener listener = new UDPListener(message -> {
            SwingUtilities.invokeLater(() -> {
                if (message.startsWith("EMERGENCY:")) {
                    JOptionPane.showMessageDialog(this, message.substring(10), "EMERGENCY ALERT", JOptionPane.ERROR_MESSAGE);
                } else if (message.startsWith("ALERT:")) {
                    JOptionPane.showMessageDialog(this, message.substring(6), "System Alert", JOptionPane.WARNING_MESSAGE);
                }
                loadData();
            });
        });
